    ...
    entries: [
      {
        ...
        desc: 'Review contact details, activity, and account signals.',
        icon: Bug,
        tag: 'Contacts',
      },
      {
        ...
        title: 'Deal intake',
        desc: 'Create and submit a sales opportunity.',
        icon: Bug,
        tag: 'Deals',
      },
      {
        ...
        title: 'Task queue',
        desc: 'Track follow-ups and sync status.',
        icon: Bug,
        tag: 'Tasks',
      },
    ],
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        title: 'Debug run',
        desc: 'Generate a quarterly reporting package.',
        icon: AlertTriangle,
        tag: 'Reports',
      },
      {
      ...
      },
      {
        ...
        title: 'Email compose',
        desc: 'Draft, save, and send customer email.',
        icon: AlertTriangle,
        tag: 'Email',
      },
      {

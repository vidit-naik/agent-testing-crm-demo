  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div>
          {/* Responsive triple-render: one visible per breakpoint. Same aria-label on all. */}
          <Button onClick={() => openModal('createAccount')} className="hidden md:inline-flex" aria-label="New Account">
            <Plus className="h-4 w-4 mr-2" />
            New Account
          </Button>
          <Button onClick={() => openModal('createAccount')} size="sm" className="hidden sm:inline-flex md:hidden" aria-label="New Account">
            <Plus className="h-4 w-4 mr-2" />
            New Account
          </Button>
          <Button onClick={() => openModal('createAccount')} size="sm" className="sm:hidden inline-flex" aria-label="New Account">
